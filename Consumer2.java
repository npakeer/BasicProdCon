...
public class Consumer {
	...
	public static void pollAll(String  TOPIC, KafkaConsumer consumer, Integer pollInterval, String printStr , Integer partId) {
    ...
    public static void main(String[] args) {
		...
		KafkaConsumer<String,String> consumer = new KafkaConsumer<String,String>(props);
			...
			pollAll (TOPIC, consumer , pollInterval, "print", 9);
	return;
    }
}
